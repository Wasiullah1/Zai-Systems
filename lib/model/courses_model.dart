  ...
  static List<model> getCoursesData() => [
       ...
       model(
        ...
        model(
          ...
          Shortdescription: 'JavaScript is a dynamic computer programming language. It is lightweight and most commonly used as a part of web pages.',
          rate: 2000,
        ),
        model(
          id: 4,
          name: 'WordPress',
          image: 'assests/course/wordpress.PNG',
          description:
          ...
          Shortdescription: 'WordPress powers nearly one-third of the world’s websites, from small personal blogs to the complex sites of major corporations.',
          rate: 2000,
        ),
       model(
            id: 5,
           ...
           Shortdescription: 'React Native is an open-source mobile application framework created by Facebook, Inc.',
           rate: 2000),
        model(
          id: 6,
          name: 'React JS',
          image: 'assests/course/React.PNG',
          description:
       ...
       model(
         ...
         Shortdescription: 'In this project based course you will learn to develop interactive and responsive websites and front-end web development.',
         rate: 2000,
        ),
        model(
          id: 9,
          name: 'WordPress',
          image: 'assests/course/Python.PNG',
          description:
              'Python is an interpreted high-level general-purpose programming language. Python\'s design philosophy emphasizes code readability with its notable use of significant indentation. Its language constructs as well as its object-oriented approach aim to help programmers write clear, logical code for small and large-scale projects.',
          Shortdescription: 'Python is an interpreted high-level general-purpose programming language.',
          rate: 2000,
        ),
       model(
            id: 10,
